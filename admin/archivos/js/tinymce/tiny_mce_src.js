	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			if (s.image && !(this.editor  &&this.editor.forcedHighContrastMode) )
				h += '<img class="mceIcon" src="../../../../archivos/js/tinymce/' + s.image + '" alt="' + DOM.encode(s.title) + '" />' + l;
			else
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			if (s.document_base_url != tinymce.documentBaseURL)
				t.iframeHTML += '<base href="../../../../archivos/js/tinymce/' + t.documentBaseURI.getURI() + '" />';
			...
			for (i = 0; i < t.contentCSS.length; i++) {
				t.iframeHTML += '<link type="text/css" rel="stylesheet" href="../../../../archivos/js/tinymce/' + t.contentCSS[i] + '" />';
			}
