...
<div class="widget " >
    ...
    <div class="widgetcontent nopadding">
    	<form class="stdform stdform2" method="post" action="tipoUsuario.php?accion=modificar&amp;id=<?php echo $row['idtipousuario'];?>">
        	<p>
                <label>Nombre</label>
                <span class="field">
                    <input type="text" id="nombre" name="nombre" class="input-xxlarge" placeholder="Nombre" value="<?php echo $row['nombretipo_usuario'];?>"/>
                </span>
            </p>
