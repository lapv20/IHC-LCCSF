...
<div class="widget ">
	<center><h4 class="widgettitle"> Nueva Empresa</h4></center>
    <div class="widgetcontent">
    	...
    	<form class="stdform" method="post" action="empresa.php?accion=nuevo">
                ...
                <input type="text" name="rif2" class="input-medium" placeholder="Cédula" maxlength="8"/>
                <input type="text" name="rif3" class="input-small" style="width:10px;"  maxlength="1"/>
            <p>
                <label>Direccion</label>
                <span class="field"><input type="text" name="direccion" class="input-medium" placeholder="Dirección" /></span>
                </span>
            </p>
