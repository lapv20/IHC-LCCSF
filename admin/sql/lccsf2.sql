...
--
-- Servidor: localhost
-- Tiempo de generación: 12-11-2014 a las 22:24:28
...
(10, '14-2', '18:18:19', 'Pendiente', 'V17707200', 1, 6, 4),
...
ALTER TABLE `historial`
  ADD CONSTRAINT `historial_ibfk_2` FOREIGN KEY (`nombre_usuario`) REFERENCES `usuario` (`nombre_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
