...
<div class="accordion accordion-primary">
    <h3><a href="#"><span class="iconfa-chevron-down"></span> ¿Cómo agrego un nuevo empleado?</a></h3>
        <div>
            <p>
                En el menu lateral izquierdo, ubique la opción "Empleados" al pulsarla
                se desplegará un sub menú, seguidamente pulse "Añadir Empleado" se mostrará
                un formulario para introducir los datos del empleado.
            </p>
        </div>
    <h3><a href="#"><span class="iconfa-chevron-down"></span> ¿Cómo modifico los datos de un empleado?</a></h3>
        <div>
            <p>
                En el menu lateral izquierdo, ubique la opción "Empleados" al pulsarla
    ...
    <h3><a href="#"><span class="iconfa-chevron-down"></span> ¿Cómo elimino un empleado del sistema?</a></h3>
        <div>
            <p>
            En el menu lateral izquierdo, ubique la opción "Empleados" al pulsarla
            se desplegará un sub menú "Administrar Empleados" se mostrarán los datos de todos los empleados, ubique el panel "opciones" en la parte derecha
    ...
    <h3><a href="#"><span class="iconfa-chevron-down"></span> ¿Cómo creo una nueva orden de servicio?</a></h3>
        <div>
            <p>
                ...
                un formulario donde podrá ubicar el empleado que tendrá la orden de servicio, indicar el perfil de los exámenes a realizar y la sucursal
                donde se realizarán.
            </p>
        </div>
