...
include_once "conexbd.php"; //es la sentencia q usaremos para incluir el archivo de conexión a la base de datos que creamos anteriormente. 
...
<div class="loginpanel">
    ...
    <div><label>Username: </label><br><input name="user" type="text" placeholder="Enter your username"></div>
    <div><label>Password:</label><br><input name="password" type="password" placeholder="Enter your password"></div>
    <br> 
