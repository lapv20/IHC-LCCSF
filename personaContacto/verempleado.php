...
<body>
	<h4 class="widgettitle">Administrar Empleados<span style="float:right;" class="iconfa-list"></span></h4>
	...
	<tbody>
	 ...
	 while($row = mysql_fetch_array($result))
	 {
	  ...
	  <tr class="gradeX">
		...
		<td>
			<center>
				<a class="btn btn-info" onClick="MM_openBrWindow('modificarempleado.php?cedula=<?php echo $row['cedula'] ?>','modificarorden','width=805,height=450')"><span class="iconfa-edit"></span></a>
				<a class="btn btn-danger" onClick="eliminar(<?php echo $row['idpaciente']; ?>);"><span class="iconfa-trash"></span></a></center></td>
			</tr>
			<?php
		}
		?>
