...
function preinit() {
	...
	if (url = tinyMCEPopup.getParam("external_link_list_url"))
		document.write('<script language="javascript" type="text/javascript" src="../../../../../../../archivos/js/tinymce/plugins/advlink/js/' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
}
