...
<div class="accordion accordion-primary">
                            ...
                            <div>
                                <p>
                                    En el menu lateral izquierdo, ubique la opción "Pacientes" al pulsarla
                                    se desplegará un sub menú, seguidamente pulse "Administrar Pacientes", al pulsar ésa opción se mostrarán
                            ...
                            <div>
                                <p>
                                    ...
                                    se desplegará un sub menú, seguidamente pulse "Administrar Pacientes", al pulsar ésa opción se mostrarán
                                    los pacientes del laboratorio, ubique el panel "opciones" en la parte derecha
                                    de la fila que contiene los datos del paciente que desea eliminar, pulse el icono de eliminar <i class="icon-trash"></i>, a continuación verá un mensaje emergente,
